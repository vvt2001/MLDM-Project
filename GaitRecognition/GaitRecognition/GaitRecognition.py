...
#        fft_array = principal_components['FFT Coefficients'].to_numpy()
#        #print(fft_array)
...
#df = pd.read_csv('C:/Users/DELL/Desktop/Test\T0_ID355444_Walk2.csv', sep=',', header=None, names=columns, usecols=selected_columns)
#df = df.drop([df.index[0], df.index[1]])
#df = df.reset_index(drop=True)
#df = df.head(300)
